...
const Product = ({product}) => {
  ...
  return (
    <div> 
      <div className='border border-emerald-500 rounded-lg h-[300px] mb-4
        ...
        <div className='w-full h-full flex justify-center items-center'>
          ...
          <div className='absolute top-6 -right-11 group-hover:right-5 
                          bg-emerald-500/40 p-2 flex flex-col
                          items-center justify-center gap-y-2
                          opacity-0 group-hover:opacity-100 
                          tranasition-all duration-300'>
            <button onClick={() => addToCart(product,id)}>
              <div className='flex justify-center items-center text-white w-12 h-12 bg-emerald-700'> 
