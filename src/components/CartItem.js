...
const CartItem = ({item}) => {
  ...
  return (
    <div className='flex gap-x-4 py-2 lg:px-6 border-b
                    border-emerald-700 w-full font-light text-gray-500'>
        ...
        <div className='w-full flex flex-col'>
          <div className='flex justify-between mb-2'>
            ...
            <div onClick={() => removeFromCart(id)}
              ...
              <IoMdClose  className='text-gray-500 hover:text-red-200 transition' />
            </div>
          </div>
          <div className='flex gap-x-2 h-[36px] text-sm'>
            ...
            <div className='flex-1 flex items-center justiy-around'>
              $ {price} 
            </div>
